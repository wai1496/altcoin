Contributing to BitGoldenCoin Core
============================

The BitGoldenCoin Core project operates an open contributor model where anyone is welcome to contribute towards development in the form of peer review, testing and patches. This document explains the practical process and guidelines for contributing.
...
The following applies to code changes to the BitGoldenCoin Core project (and related projects such as libsecp256k1), and is not to be confused with overall BitGoldenCoin Network Protocol consensus changes.

Whether a pull request is merged into BitGoldenCoin Core rests with the project merge maintainers and ultimately the project lead. 
